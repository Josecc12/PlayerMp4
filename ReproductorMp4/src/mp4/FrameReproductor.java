...
public class FrameReproductor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Guardar Lista");
...
//            reproductor.setRuta(actual.getVideo().getEnlace());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        final String nombreArchivo="playList.txt";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        InputStream is = new FileInputStream("playList.txt");
        ObjectInputStream ois = new ObjectInputStream(is);
        Lista a2 = (Lista) ois.readObject();
        this.playList = a2;
        System.out.println(a2.getFrente().getVideo().getTitulo() + "\n" + a2.getFrente().getVideo().getTitulo());
        } catch (IOException | ClassNotFoundException e) {
        System.out.println("Error: " + e.getMessage());
        }
        int i = 1;
        while (i <= playList.get_tamanio()) {
        this.list1.add(playList.buscarRandom(i).getVideo().getTitulo());
        i++;
        }
